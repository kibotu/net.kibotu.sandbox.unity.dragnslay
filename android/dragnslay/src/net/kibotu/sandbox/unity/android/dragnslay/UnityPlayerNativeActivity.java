package net.kibotu.sandbox.unity.android.dragnslay;
...
import net.kibotu.sandbox.unity.android.dragnslay.network.AndroidUnitySocketHandlerProxy;
...
public class UnityPlayerNativeActivity extends NativeActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SocketClient.init(serverUrl, new AndroidUnitySocketHandlerProxy());
        UdpSocketClient.init(serverUrl, new AndroidUnitySocketHandlerProxy());
